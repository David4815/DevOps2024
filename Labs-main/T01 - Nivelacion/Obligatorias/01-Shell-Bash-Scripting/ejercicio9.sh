...
read -p "Ingrese el directorio del cual quiere contar los archivos: " directorio
...
totalArchivos=$(ls -p $directorio | grep -v /| wc -l)
echo "El directorio \"$directorio\" contiene: $totalArchivos archivos. "
}
